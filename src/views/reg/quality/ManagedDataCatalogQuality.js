...
const ManagedDataCatalogQuality = ({ className, ...rest }) => {
    ...
    return (
        ...
        <CatalogSearchByName title='View Data Quality for selected Data Catalog' onResult={searchResult}/>
        {displaySearchResult}
        </>
    )
...
ManagedDataCatalogQuality.propTypes = {
  className: PropTypes.string
};

export default ManagedDataCatalogQuality;
