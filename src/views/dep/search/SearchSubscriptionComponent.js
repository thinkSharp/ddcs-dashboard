...
const SearchSubscriptionComponent = ({ className, ...rest }) => {
        ...
        <Table stickyHeader aria-label="sticky table">
          ...
          <TableBody>
            {rows.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                ...
                const retire = '/dep/retire/' + data_catalog;
                const acquire = '/dep/edit/' + data_catalog;
              return (
...
SearchSubscriptionComponent.propTypes = {
  className: PropTypes.string
};

export default SearchSubscriptionComponent;
